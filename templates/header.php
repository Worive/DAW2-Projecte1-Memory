<?php
$page = explode('?', str_replace(
    '#',
    '',
    basename(htmlspecialchars($_SERVER['REQUEST_URI']))))[0];
...
<header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom px-5">
    ...
    <ul class="nav nav-pills">
        <li class="nav-item">
            <a href="/DAW2-Projecte1-Memory/" class="nav-link<?php isActive('memory.php', $page, true) ?>"
